...
# Hình nền:
BACKGROUND_SPRITE: Surface = pygame.image.load("assets/anhnentrochoi.jpg").convert_alpha()
...
PLAYER_SPRITE: Surface = scale_image(pygame.image.load("assets/CONAN.png"), 0.28)
ROBOT_SPRITE: Surface = scale_image(pygame.image.load("assets/GIN.png"), 0.3)
...
TO_MO_SPRITE: Surface = scale_image(pygame.image.load("assets/HAIBARA.png"), 0.27)
